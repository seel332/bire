Privacy Policy
[Developer/Company name] built the TrappedBird app as [open source/free/freemium/ad-supported/commercial] app. This SERVICE is provided by [Developer/Company name] [at no cost] and is intended for use as is.
...
The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at TrappedBird unless otherwise defined in this Privacy Policy.
